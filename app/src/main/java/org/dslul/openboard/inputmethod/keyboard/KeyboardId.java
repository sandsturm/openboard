...
public final class KeyboardId {
    ...
    public final boolean mSeparateNumberRowEnabled;
    ...
    public KeyboardId(final int elementId, final KeyboardLayoutSet.Params params) {
        ...
        mSeparateNumberRowEnabled = params.mSeparateNumberRowEnabled;
    ...
    private boolean equals(final KeyboardId other) {
        ...
        return other.mElementId == mElementId
                ...
                && other.mSeparateNumberRowEnabled == mSeparateNumberRowEnabled
    ...
    public String toString() {
        return String.format(Locale.ROOT, "[%s %s:%s %dx%d %s %s%s%s%s%s%s%s%s%s]",
                ...
                (mSeparateNumberRowEnabled ? " separateNumberRowEnabled" : ""),
